# resume-checker
This Resume parser uses AI and machine learning techniques to automate the process of skimming through resumes and identifying the best candidates for job positions.
...
1. Clone the repository:
   ```sh
   git clone https://github.com/EthanDooh-gif/resume-parser.git
   cd resume-parser
